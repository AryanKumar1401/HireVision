        ...
        <section className="relative z-10 flex flex-col items-center justify-center px-6 py-24 text-center">
          ...
          >
            <div className="absolute inset-0">
              ...
              >
                <h3 className="text-lg font-semibold text-[#F48C06]">
                  Recruiter Dashboard
                </h3>
              </motion.div>
                          ...
                          <motion.div
                            className={`h-1.5 rounded-full ${
                              metric.value >= 80
                                ...
                                : metric.value >= 70
                                ? "bg-gradient-to-r from-[#F48C06] to-yellow-400"
                      ...
                      >
                        ...
                        <div className="bg-[#0A0F1A]/70 rounded-lg p-3 flex-grow">
                          ...
                          >
                            ...
                            knowledge in cloud architecture and DevOps
                            practices.
                          </motion.p>
                          <motion.p
                            className="text-sm text-gray-300 mb-2"
                          ...
                          >
                            Communication was clear and concise, with good
                        ...
                        <div className="flex-1 flex flex-col">
                          ...
                          >
                            ...
                            <div className="h-16 flex items-end gap-1">
                              {[
                                60, 75, 65, 80, 90, 85, 95, 85, 90, 85, 90, 92,
                              ].map((height, i) => (
                                <motion.div
                                  key={i}
