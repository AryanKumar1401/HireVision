...
export default function CandidateDashboard() {
  ...
  const pendingInterviews = [
    { id: "1", title: "Interview: Frontend Developer", scheduledDate: "April 15, 2025", company: "TechInnovate", logo: "T" },
    { id: "2", title: "Interview: UX Designer", scheduledDate: "April 18, 2025", company: "DesignCraft", logo: "D" },
  ];
        ...
        {activeTab === "stats" && (
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              ...
              <div className="bg-gray-800/50 backdrop-blur-md border border-gray-700/50 rounded-xl p-6">
                <div className="text-gray-400 text-sm mb-1">Interviews Completed</div>
              ...
              <div className="bg-gray-800/50 backdrop-blur-md border border-gray-700/50 rounded-xl p-6">
                ...
                <div className="text-2xl font-bold text-white">Problem Solving</div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-md border border-gray-700/50 rounded-xl p-6">
              <h3 className="text-lg font-medium text-white mb-4">Skill Performance</h3>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="h-2 bg-gray-700 rounded-full">
                    <div className="h-full bg-gradient-to-r from-purple-500 to-purple-400 rounded-full" style={{width: "78%"}}></div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="h-2 bg-gray-700 rounded-full">
                    <div className="h-full bg-gradient-to-r from-yellow-500 to-yellow-400 rounded-full" style={{width: "65%"}}></div>
                  </div>
                </div>
              </div>
            </div>
