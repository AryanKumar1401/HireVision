    ...
    <div className="relative min-h-screen overflow-hidden bg-gray-100">
      ...
      <aside className="fixed inset-y-0 left-0 w-64 bg-white shadow-md z-20">
        ...
        <nav className="mt-4">
          <ul>
            ...
            <li>
              <Link href="/companies/manage" className="block px-4 py-3 text-gray-700 hover:bg-gray-200">
                  Companies
              </Link>
            </li>
            <li>
              <Link href="/settings" className="block px-4 py-3 text-gray-700 hover:bg-gray-200">
                  Settings
              </Link>
            </li>
            <li>
              <Link href="/account" className="block px-4 py-3 text-gray-700 hover:bg-gray-200">
                  Account
              </Link>
            </li>
          </ul>
      ...
      <div className="ml-64 relative z-10 p-6">
        ...
        <header className="flex items-center justify-between mb-6">
          ...
          <div>
            <Link href="/account" className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
                Profile
            </Link>
          </div>
        </header>
